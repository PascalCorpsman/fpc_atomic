...
2. Download bass.pas from https://www.un4seen.com/ and store it in the "units" folder
3. Download synapse from http://www.ararat.cz/synapse/doku.php/download and store it in the "units" folder
